...
[1] Microsoft Learn. [Use the IChatClient interface](https://learn.microsoft.com/en-us/dotnet/ai/ichatclient). Updated 13 March 2026.

[2] Microsoft Learn. [The Microsoft.Extensions.AI.Evaluation libraries](https://learn.microsoft.com/en-us/dotnet/ai/evaluation/libraries). Updated 18 June 2026.

[3] Microsoft Learn. [Agent Framework: Evaluation](https://learn.microsoft.com/en-us/agent-framework/agents/evaluation). Updated 25 August 2026; constructor example qualified in this report.

[4] dotnet/extensions. [OpenAIClientExtensions.cs](https://github.com/dotnet/extensions/blob/main/src/Libraries/Microsoft.Extensions.AI.OpenAI/OpenAIClientExtensions.cs). Main-branch source; includes Chat and Responses adapters.

[5] Microsoft Learn. [Agent Framework: Anthropic model provider](https://learn.microsoft.com/en-us/agent-framework/integrations/by-component/model-providers/anthropic). Updated 4 September 2026.

[6] Microsoft Learn. [Microsoft Foundry SDKs and endpoints](https://learn.microsoft.com/en-us/azure/foundry/how-to/develop/sdk-overview). Native SDK statement qualified in this report.

[7] Microsoft Learn. [Evaluate model and agent targets with Microsoft Foundry SDK](https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/cloud-evaluation-targets). Updated 7 September 2026.

[8] Microsoft Learn. [azure.ai.evaluation package API](https://learn.microsoft.com/en-us/python/api/azure-ai-evaluation/azure.ai.evaluation?view=azure-python). Current Python API reference.

[9] Anthropic. [C# SDK](https://platform.claude.com/docs/en/cli-sdks-libraries/sdks/csharp). Official SDK, IChatClient integration and Foundry package guidance.

[10] microsoft/agent-framework. [AnthropicClientExtensions.cs](https://github.com/microsoft/agent-framework/blob/main/dotnet/src/Microsoft.Agents.AI.Anthropic/AnthropicClientExtensions.cs). Main-branch wrapper source.

[11] Microsoft Learn. [Use admin-connected models in cloud evaluations](https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/evaluate-admin-connected-models). Updated 27 August 2026; preview.

[12] Microsoft Learn. [IEvaluator.EvaluateAsync API](https://learn.microsoft.com/en-us/dotnet/api/microsoft.extensions.ai.evaluation.ievaluator.evaluateasync?view=net-10.0-pp). API reference; includes prerelease notice.

[13] Azure/azure-sdk-for-python. [Evaluation model configurations](https://github.com/Azure/azure-sdk-for-python/blob/main/sdk/evaluation/azure-ai-evaluation/azure/ai/evaluation/_model_configurations.py). Main-branch source; public versus internal configuration boundary.
...
[15] microsoft/agent-framework. [AgentEvaluationExtensions.cs](https://github.com/microsoft/agent-framework/blob/main/dotnet/src/Microsoft.Agents.AI/Evaluation/AgentEvaluationExtensions.cs). Main-branch evaluation orchestration source.

[16] microsoft/agent-framework. [FoundryEvals.cs](https://github.com/microsoft/agent-framework/blob/main/dotnet/src/Microsoft.Agents.AI.Foundry/Evaluation/FoundryEvals.cs). Main-branch project evaluation integration source.
