...
/// in place of <see cref="Model.GenerateAsync(IReadOnlyList{Provider.Core.ChatMessage}, IReadOnlyList{ToolDef}, Provider.Core.ToolChoice?, Provider.Core.GenerateConfig?, InspectAzureAI.Eval.Model.Cache.CachePolicy?, Provider.Core.StreamHandler?, CancellationToken)"/>.
/// </summary>
